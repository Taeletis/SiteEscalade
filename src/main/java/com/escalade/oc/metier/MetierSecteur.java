...
public interface MetierSecteur {
	...
	public Secteur ajouterMetierSecteur(String nom,String lienCarte,String acces,String description,Site s,Grimpeur createur);
	public Secteur modifierMetierSecteur(String nom,String lienCarte,String acces,String description,Grimpeur modificateur, Secteur secteur);
